    ...
    >
      ...
      >
        <Image
          ...
          quality={90}
        />
        {/* Adaptable Overlay: Darkens image to ensure text readability in both modes */}
      ...
      >
        <div className="flex flex-col items-center space-y-8 w-full">
          ...
          <div className="space-y-2 md:space-y-4 w-full">
            <motion.div className="overflow-hidden py-2">
              <motion.h1 
                ...
                className="font-playfair text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-[9rem] font-bold text-foreground leading-[1.1] tracking-tight"
              >
                Build The
              </motion.h1>
            </motion.div>
            ...
            <motion.div className="overflow-hidden py-2">
              <motion.h1 
                ...
                className="font-playfair text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-[9rem] font-bold text-primary leading-[1.1] tracking-tight"
              >
                Future
              </motion.h1>
            </motion.div>
            ...
            <motion.p 
              ...
              className="text-base sm:text-lg md:text-xl xl:text-2xl text-muted-foreground max-w-2xl xl:max-w-3xl mx-auto leading-relaxed mt-8"
            >
          ...
          >
            ...
            <button className="w-full sm:w-auto px-8 py-4 bg-transparent border border-border text-foreground hover:bg-secondary rounded-full font-semibold transition-all duration-300">
              Start Project
            </button>
          </motion.div>
        </div>
